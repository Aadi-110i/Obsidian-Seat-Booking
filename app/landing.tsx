        ...
        <section style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '24px 0', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', overflow: 'hidden', whiteSpace: 'nowrap', display: 'flex' }}>
             <div style={{ display: 'inline-flex', alignItems: 'center', animation: 'marquee 40s linear infinite' }}>
               {[1, 2, 3].map((set) => (
                 <div key={set} style={{ display: 'flex', gap: 60, paddingRight: 60, alignItems: 'center' }}>
             ...
             <style>{`@keyframes marquee { 0% { transform: translateX(0); } 100% { transform: translateX(-33.3333333333%); } }`}</style>
          </div>
