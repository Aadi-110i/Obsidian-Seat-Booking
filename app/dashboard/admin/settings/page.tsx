        ...
        <div className="fade-in">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
                    ...
                    {loading ? (
                        ...
                        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                <label className="label" style={{ marginBottom: 0 }}>New Cycle Start Date (must be a Monday)</label>
                ...
                <div className="card">
                    ...
                    <div style={{ marginTop: 16, display: 'flex', gap: 12, padding: 16, borderRadius: 12, background: 'rgba(59, 130, 246, 0.08)', border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                        <Info size={18} style={{ flexShrink: 0, marginTop: 2, color: '#3b82f6' }} />
                        <div>
                            <span style={{ fontWeight: 600, display: 'block', marginBottom: 4, color: '#3b82f6' }}>Floating Seats Rule</span>
                            <span style={{ fontSize: 13, lineHeight: 1.5, color: 'var(--text-secondary)' }}>F01–F10 are always available, but unlock for the next day only after <strong style={{ color: 'var(--text-primary)' }}>3:00 PM</strong> today. Both batches can book floating seats on any day.</span>
                        </div>
                    </div>
                </div>
            </div>
